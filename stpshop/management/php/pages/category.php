...
<div class="form-group">
   ...
   <br> <input type="text" class="form-control mb-3" id="category_name" name="category_name">
</div>
...
<table class="table">
  ...
  <tbody>
    ...
    <td><i class='fas fa-edit text-primary cat_edit_btn' id='".$aa['id']."'></i></td>
   <td><i class='fas fa-trash text-danger cat_del_btn' id='".$aa['id']."'></i></td>
      ...
      $.ajax({
        ...
        success: function(response) {
          if(response.trim() == "success"){
            ...
            $('[p_link="category"]').click(); // reload the category section
          } else {
