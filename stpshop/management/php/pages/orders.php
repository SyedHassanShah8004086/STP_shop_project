...
<input type="date" name="o_date" class="form_control w-25 me-3">
...
ps="<i class='fa-regular fa-circle-check text-success fs-3'></i>";
...
os="<i class='fa-regular fa-circle-check text-success fs-3'></i>";
        ...
        data:{
            ...
            success:function(response){
              if(response.trim()=="success"){
                $(element).html("<i class='fa-regular fa-circle-check text-success fs-3'></i>");
              }
            }
        }
       })
